...
const SYSTEM_PROMPT = [
  ...
  '- The idea must function as a game. Keep it quirky and fun, but make sure a reader',
  '  can tell what the player actually does. A one-sentence core loop should be obvious',
