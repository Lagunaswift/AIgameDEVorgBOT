// Entry point: client with the exact intents + partials the spec requires, firebase init,
// event handlers registered once at startup (not per-connection), command registry loaded
// onto the client, weekly post scheduled, then login.
